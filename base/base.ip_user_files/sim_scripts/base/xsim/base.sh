...
# Set xvlog options
xvlog_opts="--incr --relax -L uvm -L axi_vip_v1_1_12 -L smartconnect_v1_0 -L zynq_ultra_ps_e_vip_v1_0_12 -L vid_phy_controller_v2_2_13 -L v_hdmi_rx_v3_0_0 -L mipi_dphy_v4_3_4 -L v_hdmi_tx_v3_0_0 -L xilinx_vip"
